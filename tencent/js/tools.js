var tools = (function(){
	var toolsObj = {
		...
		//碰撞检测
		//动框是否存在一个点,这个点的x坐标在（）内，且y坐标在（）内 前者是拖得 后者是静止的
		peng:function(obj1,obj2){

			var obj1Rect = tools.getEleRect(obj1);
			var obj2Rect = tools.getEleRect(obj2);

			var obj1R = obj1Rect.right;
			var obj1B = obj1Rect.bottom;
			var obj1L = obj1Rect.left;
			var obj1T = obj1Rect.top;

			var obj2R = obj2Rect.right;
			var obj2B = obj2Rect.bottom;
			var obj2L = obj2Rect.left;
			var obj2T = obj2Rect.top;
			...
			/*
		    minX<rangeMaxX&&maxX>rangeMinX
		    minY<rangeMaxY&&maxY>rangeMinY
		    return true;*/
